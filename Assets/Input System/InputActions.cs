...
public partial class @InputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@InputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Windows.enabled, "This will cause a leak and performance issues, InputActions.Windows.Disable() has not been called.");
    ...
    public struct WindowsActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public WindowsActions(@InputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
