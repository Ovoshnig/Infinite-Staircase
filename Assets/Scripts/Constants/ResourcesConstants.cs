public static class ResourcesConstants
{
    ...
    public const string ResourcesListName = "resourcesList";
    ...
    public const string PlayerFootstepPath = "Audio/SFX/Player/Footsteps";
    public const string PlayerLandPath = "Audio/SFX/Player/Land";
}
